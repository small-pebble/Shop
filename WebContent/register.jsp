	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" style="margin-top: 5px;" method="post" action="${pageContext.request.contextPath}/register">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							...
							<label class="error" for="sex" style="display:none">性别必须选</label>
						</div>
					</div>
					<div class="form-group">
